# name file : play_hiragana_level_6.py
# python version 3
...
from game_screens.overscreen_levels.hiragana_mode import dead_hiragana_level_6
# import levels
...
from hiragana_mode.levelplay.mainlevel.hiragana_level_6.player_level_6 \
