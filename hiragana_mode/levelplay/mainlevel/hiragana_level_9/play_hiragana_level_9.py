# name file : play_hiragana_level_9.py
# python version 3
...
from game_screens.overscreen_levels.hiragana_mode import dead_hiragana_level_9
# import levels
...
from hiragana_mode.levelplay.mainlevel.hiragana_level_9.player_level_9 \
