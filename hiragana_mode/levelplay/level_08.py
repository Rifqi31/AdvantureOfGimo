...
class Level_08(Level):
    def __init__(self, player):
        ...
        water_level08 = [[platforms_bad_sprite.medium_long_water, 350, 531],
        ...
        # hiragana point
        hiragana_ma = [[platforms_hiragana.hiragana_ma, 420, 210]]
        hiragana_mi = [[platforms_hiragana.hiragana_mi, 820, 10]]
        hiragana_mu = [[platforms_hiragana.hiragana_mu, 180, 130]]
        hiragana_me = [[platforms_hiragana.hiragana_me, 0, 20]]
        hiragana_mo = [[platforms_hiragana.hiragana_mo, 1520, 380]]
        ...
        for platform in hiragana_ma:
            true_point_lv8 = platforms_hiragana.Platform_hiragana_katakana(
                platform[0])
