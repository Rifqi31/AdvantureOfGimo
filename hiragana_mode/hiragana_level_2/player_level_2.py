...
from hiragana_mode.overscreen_hiragana import (
    dead_hiragana_level_2, dead_hiragana_level_3, 
    dead_hiragana_level_4, dead_hiragana_level_5, 
    dead_hiragana_level_6, dead_hiragana_level_7, 
    dead_hiragana_level_8, dead_hiragana_level_9, 
    dead_hiragana_level_10, dead_hiragana_level_11
)
