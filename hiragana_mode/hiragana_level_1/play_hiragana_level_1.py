# name file : play_hiragana_level_1.py
# python version 3
...
# from hiragana_mode.overscreen_hiragana import dead_hiragana_level_1
# import levels
...
from hiragana_mode.hiragana_level_1.player_level_1 \
