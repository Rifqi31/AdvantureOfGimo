...
class Level_10(Level):
    def __init__(self, player):
        ...
        # Hiragana Point
        hiragana_ra = [[platforms_hiragana.hiragana_ra, 1050, 20]]
        hiragana_ri = [[platforms_hiragana.hiragana_ri, 350, 100]]
        hiragana_ru = [[platforms_hiragana.hiragana_ru, 0, 20]]
        hiragana_re = [[platforms_hiragana.hiragana_re, 1650, 100]]
        ...
        for platform in hiragana_ra:
            true_point_lv10 = platforms_hiragana.Platform_hiragana_katakana(
                platform[0])
