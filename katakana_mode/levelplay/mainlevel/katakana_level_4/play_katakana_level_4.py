# name file : play_katakana_level_4.py
# python version 3
...
from game_screens.overscreen_levels.hiragana_mode import dead_hiragana_level_4
# import levels
...
from katakana_mode.levelplay.mainlevel.katakana_level_4.player_level_4 \
