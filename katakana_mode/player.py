...
from katakana_mode.platforms import MovingPlatform_dirt, MovingPlatform_dark_brick, MovingPlatform_snow, MovingPlatform_dirt_sand, MovingPlatform_brick_red, MovingPlatform_ancient_brick
...
class Player(pygame.sprite.Sprite):
	...
	def update(self):
		...
		point1_katakana_lv1 = pygame.sprite.spritecollide(self, self.level.katakana_A, True)
		point2_katakana_lv1 = pygame.sprite.spritecollide(self, self.level.katakana_I, True)
		point3_katakana_lv1 = pygame.sprite.spritecollide(self, self.level.katakana_U, True)
		...
		point1_katakana_lv2 = pygame.sprite.spritecollide(self, self.level.katakana_A_lv2, True)
		point2_katakana_lv2 = pygame.sprite.spritecollide(self, self.level.katakana_I_lv2, True)
		point3_katakana_lv2 = pygame.sprite.spritecollide(self, self.level.katakana_U_lv2, True)
		point4_katakana_lv2 = pygame.sprite.spritecollide(self, self.level.katakana_E, True)
		point5_katakana_lv2 = pygame.sprite.spritecollide(self, self.level.katakana_O, True)

		point6_katakana_lv2 = pygame.sprite.spritecollide(self, self.level.katakana_KA, True)
		point7_katakana_lv2 = pygame.sprite.spritecollide(self, self.level.katakana_KI, True)
		# If user get point katakana U
		...
		for false_point_lv2 in point6_katakana_lv2:
			configsounds.denied_sfx.play()
			self.scores -= 100
			self.health_number -= self.false_point_dmg
		...
		for false_point_lv2 in point7_katakana_lv2:
			configsounds.denied_sfx.play()
			self.scores -= 100
			self.health_number -= self.false_point_dmg
		...
		point1_katakana_lv3 = pygame.sprite.spritecollide(self, self.level.katakana_KA_lv3, True)
		point2_katakana_lv3 = pygame.sprite.spritecollide(self, self.level.katakana_KI_lv3, True)
		point3_katakana_lv3 = pygame.sprite.spritecollide(self, self.level.katakana_KU, True)
		point4_katakana_lv3 = pygame.sprite.spritecollide(self, self.level.katakana_KE, True)
		point5_katakana_lv3 = pygame.sprite.spritecollide(self, self.level.katakana_KO, True)
		...
		point1_katakana_lv4 = pygame.sprite.spritecollide(self, self.level.katakana_SA, True)
		point2_katakana_lv4 = pygame.sprite.spritecollide(self, self.level.katakana_SI, True)
		point3_katakana_lv4 = pygame.sprite.spritecollide(self, self.level.katakana_SU, True)
		point4_katakana_lv4 = pygame.sprite.spritecollide(self, self.level.katakana_SE, True)
		point5_katakana_lv4 = pygame.sprite.spritecollide(self, self.level.katakana_SO, True)
		...
		point1_katakana_lv5 = pygame.sprite.spritecollide(self, self.level.katakana_TA, True)
		point2_katakana_lv5 = pygame.sprite.spritecollide(self, self.level.katakana_TI, True)
		point3_katakana_lv5 = pygame.sprite.spritecollide(self, self.level.katakana_TU, True)
		point4_katakana_lv5 = pygame.sprite.spritecollide(self, self.level.katakana_TE, True)
		point5_katakana_lv5 = pygame.sprite.spritecollide(self, self.level.katakana_TO, True)
		...
		point1_katakana_lv6 = pygame.sprite.spritecollide(self, self.level.katakana_RA, True)
		point2_katakana_lv6 = pygame.sprite.spritecollide(self, self.level.katakana_RI, True)
		point3_katakana_lv6 = pygame.sprite.spritecollide(self, self.level.katakana_RU, True)
		point4_katakana_lv6 = pygame.sprite.spritecollide(self, self.level.katakana_RE, True)
		point5_katakana_lv6 = pygame.sprite.spritecollide(self, self.level.katakana_RO, True)
		...
		point1_katakana_lv7 = pygame.sprite.spritecollide(self, self.level.katakana_MA, True)
		point2_katakana_lv7 = pygame.sprite.spritecollide(self, self.level.katakana_MI, True)
		point3_katakana_lv7 = pygame.sprite.spritecollide(self, self.level.katakana_MU, True)
		point4_katakana_lv7 = pygame.sprite.spritecollide(self, self.level.katakana_ME, True)
		point5_katakana_lv7 = pygame.sprite.spritecollide(self, self.level.katakana_MO, True)
		...
		# For level 8 katakana Mode
		point1_katakana_lv8 = pygame.sprite.spritecollide(self, self.level.katakana_NA, True)
		point2_katakana_lv8 = pygame.sprite.spritecollide(self, self.level.katakana_NI, True)
		point3_katakana_lv8 = pygame.sprite.spritecollide(self, self.level.katakana_NU, True)
		point4_katakana_lv8 = pygame.sprite.spritecollide(self, self.level.katakana_NE, True)
		point5_katakana_lv8 = pygame.sprite.spritecollide(self, self.level.katakana_NO, True)
		...
		point1_katakana_lv9 = pygame.sprite.spritecollide(self, self.level.katakana_HA, True)
		point2_katakana_lv9 = pygame.sprite.spritecollide(self, self.level.katakana_HI, True)
		point3_katakana_lv9 = pygame.sprite.spritecollide(self, self.level.katakana_HU, True)
		point4_katakana_lv9 = pygame.sprite.spritecollide(self, self.level.katakana_HE, True)
		point5_katakana_lv9 = pygame.sprite.spritecollide(self, self.level.katakana_HO, True)
		...
		for true_point_lv9 in point4_katakana_lv9:
			configsounds.coin_sfx.play()
			configsounds.coin_sfx.set_volume(0.5)
			self.scores += 100
		...
		for true_point_lv9 in point5_katakana_lv9:
			configsounds.coin_sfx.play()
			configsounds.coin_sfx.set_volume(0.5)
			self.scores += 100
		...
		point1_katakana_lv10 = pygame.sprite.spritecollide(self, self.level.katakana_YA, True)
		point2_katakana_lv10 = pygame.sprite.spritecollide(self, self.level.katakana_YU, True)
		point3_katakana_lv10 = pygame.sprite.spritecollide(self, self.level.katakana_YO, True)
		...
		point1_katakana_lv11 = pygame.sprite.spritecollide(self, self.level.katakana_WA, True)
		point2_katakana_lv11 = pygame.sprite.spritecollide(self, self.level.katakana_WO, True)
		point3_katakana_lv11 = pygame.sprite.spritecollide(self, self.level.katakana_N, True)
