# name file : play_katakana_level_2.py
# python version 3
...
# from katakana_mode.overscreen_katakana import dead_katakana_level_2
# import levels
...
from katakana_mode.katakana_level_2.player_level_2 \
