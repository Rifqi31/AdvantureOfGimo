# name file : play_katakana_level_1.py
# python version 3
...
def gameplay():
    ...
    while not gameExit:
        ...
        if current_level == level_list[0]:
            ...
            if player.special_remove_A \
                    or player.special_remove_I == True:
            ...
            if player.special_remove_U_lv2 == False:
                if bullet.confirm_katakana == False:
                    settings.msg_to_screen(
                        "salah",
                        constants.RED,
                        400, 0,
            ...
            if player.special_remove_A_lv2 \
                    or player.special_remove_I_lv2 \
                    or player.special_remove_U_lv2 \
                    or player.special_remove_E \
                    or player.special_remove_O == True:
                if bullet.confirm_katakana == True:
                    settings.msg_to_screen(
                        "benar",
                        constants.GREEN,
